...
public class LineBounces extends Study
{
    ...
    public void onBarClose(DataContext ctx)
    {
        ...
        boolean bShow200 = getSettings().getBoolean("SHOW200");
        boolean bShow21 = getSettings().getBoolean("SHOW21");
        ...
        if (bShow21 && hi > ema21 && lo < ema21){
            sMsg = "Touching EMA 21";
            ctx.signal(index, Signals.TOUCH, "Touching EMA 21", close);
            return;
        }

        if (bShow200 && hi > ema200 && lo < ema200){
            sMsg = "Touching EMA 200";
            ctx.signal(index, Signals.TOUCH, "Touching EMA 200", close);
            return;
        }
    ...
    public void initialize(Defaults defaults)
    {
        ...
        grp3.addRow(new BooleanDescriptor("SHOW21", "Show EMA 21 touches", true));
